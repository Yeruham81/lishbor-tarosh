...
/**
 * Globally-mounted preferences dialog. Opens whenever any component
 * dispatches `openCookiePreferences()`. Reuses the centralized consent
 * storage — never touches localStorage directly.
 */
