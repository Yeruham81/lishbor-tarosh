        ...
        <div className="max-w-5xl mx-auto mt-12 sm:mt-16">
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-12">
            ...
            <div className="rounded-3xl bg-card border shadow-card p-6 sm:p-8 text-right">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
                במהלך המשחק תוכלו לצבור נקודות, לעבור שלבים, להשלים אתגרים ולהתמודד על מקום בטבלת השחקנים המובילים. אם
                תרצו לעקוב אחר הביצועים שלכם תוכלו לעשות זאת בעמוד הסטטיסטיקות האישיות. יצאתם מהמשחק? בכל שלב תוכלו
                להתחבר שוב ולהמשיך לשחק בדיוק מהנקודה שבה הפסקתם.
              </p>
            </div>
          </div>
