      ...
      <section className="container mx-auto px-4 py-12 sm:py-20">
        ...
        <div className="max-w-5xl mx-auto mt-12 sm:mt-16">
          <div className="text-center max-w-3xl lg:max-w-4xl mx-auto">
            ...
            <p className="text-xl sm:text-2xl text-muted-foreground leading-relaxed text-right">
            ...
            <div className="rounded-3xl bg-card border shadow-card p-6 sm:p-8 text-right">
              ...
              <ul className="space-y-3 text-lg sm:text-xl text-muted-foreground leading-relaxed">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-primary font-bold shrink-0">✓</span>
                  <span>
                    מתאים גם לפותרים מתחילים שרוצים לצבור ניסיון ולהשתפר בהדרגה, וגם לחובבי תשבצי היגיון ותיקים שמחפשים
                    איך לחדד את החשיבה.
                  </span>
                </li>
            ...
            <div className="rounded-3xl bg-card border shadow-card p-6 sm:p-8 text-right">
              ...
              <ul className="space-y-3 text-lg sm:text-xl text-muted-foreground leading-relaxed">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-primary font-bold shrink-0">✓</span>
                  <span>
                    ככל שתשחקו יותר, תצברו ניסיון ותשתפרו. עמוד הסטטיסטיקות האישיות יעזור לכם לעקוב אחר ההתקדמות שלכם.
                  </span>
                </li>
