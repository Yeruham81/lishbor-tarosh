        ...
        <div className="bg-card border rounded-3xl shadow-card p-5 sm:p-8">
          ...
          <Tabs value={tab} onValueChange={onTabChange} dir="rtl">
            ...
            <TabsContent value="scoring" className="text-right leading-relaxed space-y-4">
              ...
              <p className="text-muted-foreground">
                החל מהטעות הרביעית כל אות שגויה מורידה נקודה אחת. שימוש ברמז מוריד שתי נקודות. דילוג להגדרה הבאה לא מוריד נקודות אבל מאפס את הרצף.&nbsp;
              </p>
              ...
              <p className="text-muted-foreground">
                ככל שתצברו יותר נקודות, תתקדמו בשלבים, תשלימו אתגרים ותזכו בנקודות בונוס. כל הישג יפתח עבורכם אפשרויות חדשות עם אתגרים נוספים.
              </p>
            </TabsContent>
