        ...
        <div className="bg-card border rounded-3xl shadow-card p-5 sm:p-8">
          ...
          <Tabs value={tab} onValueChange={onTabChange} dir="rtl">
            ...
            <TabsContent value="tips" className="text-right leading-relaxed space-y-4">
              ...
              <p className="text-muted-foreground">
                קראו את ההגדרה היטב
                לפעמים כל מילה חשובה ויכולה להכיל רמז נסתר.

                חפשו משחקי מילים
                ראשי תיבות, פירוק מילים, צלילים דומים ושינוי סדר אותיות הם חלק נפוץ בתשבצי היגיון.

                שימו לב לאורך המילה
                אורך הפתרון יכול לעזור לצמצם אפשרויות. למשל, מילה בת שתי אותיות היא לרוב מילת קישור או מילית.

                התחילו מהאותיות הנפוצות בעברית
                א', י', ה', ו', מ', ל', ר', נ' מופיעות לעיתים קרובות ויכולות לעזור בניחוש ראשוני.

                חשבו מחוץ לקופסה
                לא תמיד הכוונה היא למשמעות הפשוטה ביותר של המילים.

                נתקעתם אחרי שתי טעויות? השתמשו ברמז
                לפעמים אות אחת נוספת יכולה לקדם אתכם אל הפתרון.

                אל תיתקעו יותר מדי
                אם הגדרה לא מתחברת לכם אתם תמיד יכולים לדלג עליה ולהמשיך הלאה.

                שחקו קצת כל יום
                ככל שתפתרו יותר הגדרות לאורך זמן תלמדו לזהות דפוסים ותפתחו דרכי חשיבה שיעזרו לכם להשתפר.
              </p>
            </TabsContent>
          </Tabs>
        </div>
