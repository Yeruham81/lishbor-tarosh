          ...
          <Tabs value={tab} onValueChange={onTabChange} dir="rtl">
            ...
            <TabsContent value="tips" className="text-right leading-relaxed space-y-4">
              ...
              <p className="text-muted-foreground whitespace-pre-line">
                קראו את ההגדרה היטב וחשבו מחוץ לקופסא - כל מילה חשובה ולא תמיד הכוונה היא למשמעות הפשוטה או המוכרת ביותר שלה.
              </p>
              <p className="text-muted-foreground">
              ...
              <p className="text-muted-foreground whitespace-pre-line">
                חפשו משחקי מילים&nbsp;- כפל משמעות, קיצורים וראשי תיבות, פירוק מילים, צלילים דומים, שיכול אותיות, גימטריה, קריאה מהסוף להתחלה ומילים משותפות - אלו הם רק חלק מהטריקים הנפוצים בהגדרות היגיון.
              </p>
              <p className="text-muted-foreground">
                אל תתעכבו יותר מדי - נתקעתם אחרי 2 טעויות? קחו רמז ואולי תצליחו לפתור. ההגדרה לא מתחברת לכם? בכל שלב ניתן לדלג עליה ולעבור להגדרה הבאה.&nbsp;
              </p>
              <p className="text-muted-foreground">
                שחקו קצת כל יום — עם הזמן תלמדו לזהות תבניות, תכירו את הטריקים, תחדדו את דרכי החשיבה שלכם ותשתפרו במשחק.
              </p>
            </TabsContent>
          </Tabs>
        </div>
