        ...
        <div className="bg-card border rounded-3xl shadow-card p-5 sm:p-8">
          ...
          <Tabs value={tab} onValueChange={onTabChange} dir="rtl">
            ...
            <TabsContent value="rules" className="text-right leading-relaxed space-y-4">
              ...
              <p className="text-muted-foreground">
                כל אות שתבחרו תיחשף בכל המקומות שבהם היא מופיעה בתשובה. אם האות אינה מופיעה בתשובה, היא תיחשב כטעות.
                לאחר שתי טעויות תוכלו להשתמש ברמז, שיחשוף אות נוספת תמורת נקודות.
              </p>
              <p className="text-muted-foreground">
                השלימו את הפיתרון כדי להתקדם להגדרה הבאה, לצבור נקודות לעבור שלבים ולהשלים אתגרים.
              </p>
              <p className="text-muted-foreground">
                ניתן לדלג על הגדרה בכל שלב, אך דילוג מאפס את הרצף ועלול לגרור אובדן נקודות. השלימו את ההגדרה כדי להתקדם
                להגדרה הבאה ולצבור ניקוד.
              </p>
              <p className="text-muted-foreground">המטרה: לפתור כמה שיותר הגדרות, רצוי ברצף ארוך, ולעלות שלבים.</p>
            </TabsContent>
            ...
            <TabsContent value="scoring" className="text-right leading-relaxed space-y-4">
              ...
              <p className="text-muted-foreground whitespace-pre-line">
                פתרון ללא רמזים ועם עד שלוש טעויות נחשב פתרון מושלם ונספר ברצף ההישגים שלכם. דילוג על הגדרה לא עולה
                נקודות אבל מאפס את הרצף.&nbsp;
              </p>
              <p className="text-muted-foreground">
                ככל שתצברו יותר נקודות והישגים תזכו בבונוסים ותעלו שלבים. כל שלב יפתח עבורכם אפשרויות חדשות ואתגרים
                נוספים.
              </p>
            </TabsContent>
