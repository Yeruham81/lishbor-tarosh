        ...
        <div className="bg-card border rounded-3xl shadow-card p-5 sm:p-8">
          ...
          <Tabs value={tab} onValueChange={onTabChange} dir="rtl">
            ...
            <TabsContent value="rules" className="text-right leading-relaxed space-y-4">
              ...
              <p className="text-muted-foreground">
                כל אות שתבחרו תיחשף בכל המקומות שבהם היא מופיעה בתשובה. אם האות לא מופיעה בתשובה היא תיחשב כטעות. לאחר שתי טעויות תיפתח האפשרות לבקש רמז, שיחשוף אות נוספת בתמורה לנקודות.
              </p>
              <p className="text-muted-foreground">
                ניתן לדלג על הגדרה בכל שלב, אך דילוג מאפס את הרצף ועלול לעלות בנקודות. השלימו את ההגדרה כדי להתקדם להגדרה הבאה ולצבור ניקוד.
              </p>
              <p className="text-muted-foreground">
