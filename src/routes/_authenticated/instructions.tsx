        ...
        <div className="bg-card border rounded-3xl shadow-card p-5 sm:p-8">
          ...
          <Tabs value={tab} onValueChange={onTabChange} dir="rtl">
            ...
            <TabsContent value="scoring" className="text-right leading-relaxed space-y-4">
              ...
              <p className="text-muted-foreground">
                כל הגדרה מתחילה ב‑10 נקודות - שלוש הטעויות הראשונות לא עולות דבר כדי לתת לכם מרחב לחשוב ולנסות.
              </p>
              <p className="text-muted-foreground">
                החל מהטעות הרביעית כל אות שגויה גורעת נקודה אחת. שימוש ברמז גורע שתי נקודות. הציון המינימלי על פתרון הוא 2
                נקודות.
              </p>
              <p className="text-muted-foreground whitespace-pre-line">
                פתרון ללא רמזים ועם עד שלוש טעויות נחשב פתרון מושלם ונצבר ברצף ההישגים שלכם. דילוג על הגדרה לא עולה נקודות אבל מאפס את הרצף.&nbsp;
                {"\n\n"}
                השלמת אתגרים וצבירת הישגים תזכה אתכם בבונוסים אוטומטיים.
              </p>
              <p className="text-muted-foreground">
                ככל שתצברו יותר נקודות תעלו שלבים. כל שלב חדש יפתח עבורכם אפשרויות חדשות ואתגרים נוספים.
              </p>
            </TabsContent>
