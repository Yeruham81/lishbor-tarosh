          ...
          <Tabs value={tab} onValueChange={onTabChange} dir="rtl">
            ...
            <TabsContent value="tips" className="text-right leading-relaxed space-y-4">
              ...
              <p className="text-muted-foreground whitespace-pre-line">
                קראו את ההגדרה היטב וחשבו מחוץ לקופסה - כל מילה חשובה אבל לא בהכרח במשמעות הפשוטה או המוכרת ביותר שלה.
              </p>
              <p className="text-muted-foreground">
              ...
              <p className="text-muted-foreground">
                אל תתעכבו יותר מדי - נתקעתם אחרי 2 טעויות? קחו רמז - אולי הוא יוביל אתכם לפתרון. ההגדרה לא מתחברת לכם? אפשר לדלג עליה ולעבור להגדרה הבאה.&nbsp;
              </p>
              <p className="text-muted-foreground">
