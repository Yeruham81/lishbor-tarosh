        ...
        <div className="bg-card border rounded-3xl shadow-card p-5 sm:p-8">
          ...
          <Tabs value={tab} onValueChange={onTabChange} dir="rtl">
            ...
            <TabsContent value="scoring" className="text-right leading-relaxed space-y-4">
              ...
              <p className="text-muted-foreground">
                מהטעות הרביעית ואילך כל אות שגויה מורידה נקודה אחת. שימוש ברמז מוריד שתי נקודות. דילוג להגדרה הבאה לא מוריד נקודות אבל מאפס את הרצף.&nbsp;
              </p>
              <p className="text-muted-foreground whitespace-pre-line">
                פתרון ללא רמזים ועם שלוש טעויות לכל היותר נחשב פתרון מושלם, מעניק לכם 10 נקודות ונספר ברצף ההישגים שלכם.&nbsp;הניקוד המינימלי האפשרי על פתרון הוא 2 נקודות.
              </p>
              <p className="text-muted-foreground">
                ככל שתצברו יותר נקודות, תתקדמו בשלבים, תשלימו אתגרים ותזכו בנקודות בונוס. כל הישג יפתח עבורכם אפשרויות חדשות ואתגרים נוספים.
              </p>
            </TabsContent>
