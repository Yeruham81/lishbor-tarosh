        ...
        <div className="bg-card border rounded-3xl shadow-card p-5 sm:p-8">
          ...
          <Tabs value={tab} onValueChange={onTabChange} dir="rtl">
            ...
            <TabsContent value="rules" className="text-right leading-relaxed space-y-4">
              ...
              <p className="text-muted-foreground">
                אם האות שבחרתם קיימת בתשובה היא תיחשף בכל המקומות שבהם היא מופיעה. אם האות שבחרתם לא קיימת בתשובה, היא
                תיחשב כטעות.
              </p>
              <p className="text-muted-foreground">
            ...
            <TabsContent value="scoring" className="text-right leading-relaxed space-y-4">
              ...
              <p className="text-muted-foreground">
                שלוש הטעויות הראשונות לא מורידות ניקוד. מהטעות הרביעית ואילך, כל אות שגויה מורידה נקודה אחת. שימוש ברמז
                מוריד שתי נקודות. דילוג ומעבר להגדרה הבאה לא מוריד נקודות, אך מאפס את הרצף.&nbsp;
              </p>
              <p className="text-muted-foreground whitespace-pre-line">
                פתרון ללא רמזים, עם שלוש טעויות או פחות, נחשב פתרון מושלם, מזכה אתכם ב־10 נקודות ונספר ברצף ההישגים
                שלכם.&nbsp;הניקוד המינימלי האפשרי לפתרון הוא 2 נקודות.
              </p>
              <p className="text-muted-foreground">
                ככל שתצברו יותר נקודות, תתקדמו בשלבים, תשלימו אתגרים ותזכו בנקודות בונוס. כל הישג יפתח בפניכם אפשרויות
                חדשות ואתגרים נוספים.
              </p>
            </TabsContent>
            ...
            <TabsContent value="tips" className="text-right leading-relaxed space-y-4">
              ...
              <p className="text-muted-foreground whitespace-pre-line">
                קראו את ההגדרה היטב ונסו לחשוב מחוץ לקופסה - כל מילה חשובה אבל לא בהכרח במשמעותה הפשוטה או המוכרת ביותר.
              </p>
              <p className="text-muted-foreground">
                שימו לב למספר המילים בפתרון ולאורכן - למשל, מילה בת שתי אותיות היא לרוב מילת קישור או מילית.
              </p>
              <p className="text-muted-foreground whitespace-pre-line">
              ...
              <p className="text-muted-foreground">
                הפתרון לא ברור לכם? הציצו בהסבר, קראו שוב את ההגדרה ונסו להבין מה פספסתם.
              </p>
              <p className="text-muted-foreground">
                הקפידו לשחק מדי יום — תוך זמן קצר תלמדו לזהות תבניות נפוצות, תחדדו את דרכי החשיבה שלכם ותשתפרו במשחק.
              </p>
            </TabsContent>
          </Tabs>
        </div>
