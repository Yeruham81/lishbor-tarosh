 ...
 *
 * both-sides → left + right * left-and-bottom → left + bottom * right-and-bottom → right + bottom *
 * Every desktop layout contains at least one side advertisement and never  displays more than two advertisements. *
 * Mobile and narrow screens ignore this layout and show only the bottom unit. */ export type RandomDesktopAdLayout =
  | "both-sides"
  | "left-and-bottom"
  | "right-and-bottom";
/**
...
export type AdPositionConfig = { slotId: string };
/**
